    ...
    def _evaluate(self, Gs, num_gpus):
        ...
        for gpu_idx in range(num_gpus):
            with tf.device('/gpu:%d' % gpu_idx):
                ...
                #distance_measure = misc.load_pkl('https://drive.google.com/uc?id=1N2-m9qszOeVC9Tq77WxsLnuWwOedQiD2')
                distance_measure = misc.load_pkl('/home/cc//stylegan/cache/vgg16_zhang_perceptual.pkl')
