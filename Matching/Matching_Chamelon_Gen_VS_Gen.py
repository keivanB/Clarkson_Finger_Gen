...
def Matching(fn):
    p = subprocess.check_call(["/NBIS/bozorth3/bin/bozorth3", "-o", "/Synt/Matching_Gen/"+str(fn)+".scr", "-A", "outfmt=sg", "-A", "maxfiles=51000", "-p", "/Synt/Gen_Minuteas/"+str(fn)+".xyt", "-G", "/Synt/All_Gen.txt"]) 
